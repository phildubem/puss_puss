...
class MTextTheme {
  ...
  static TextTheme lightTheme = TextTheme(
    ...
    bodySmall: TextStyle().copyWith(fontSize: 14, fontWeight: FontWeight.w300, color: Colors.black.withOpacity(0.5)),

    labelLarge: TextStyle().copyWith(fontSize: 14, fontWeight: FontWeight.normal, color: Colors.black),
    labelMedium: TextStyle().copyWith(fontSize: 12, fontWeight: FontWeight.normal, color: Colors.black.withOpacity(0.5)),
    labelSmall: TextStyle().copyWith(fontSize: 10, fontWeight: FontWeight.normal, color: Colors.black.withOpacity(0.5)),
  );
  ...
  static TextTheme  darkTheme = TextTheme (
    ...
    bodySmall: TextStyle().copyWith(fontSize: 14, fontWeight: FontWeight.w300, color: Colors.white.withOpacity(0.5)),

    labelLarge: TextStyle().copyWith(fontSize: 14, fontWeight: FontWeight.normal, color: Colors.white),
    labelMedium: TextStyle().copyWith(fontSize: 12, fontWeight: FontWeight.normal, color: Colors.white.withOpacity(0.5)),
    labelSmall: TextStyle().copyWith(fontSize: 10, fontWeight: FontWeight.normal, color: Colors.white.withOpacity(0.5)),
  );
}
